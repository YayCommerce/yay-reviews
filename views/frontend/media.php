            ...
            <div class="flex gap-4 flex-col">
                <div class="flex gap-2 flex-col">
                    <div class="flex items-center gap-2">
                        ...
                        ' . ( 'yes' === get_option( 'woocommerce_review_rating_verification_label' ) && $verified ? '<span class="inline-block align-top" title="' . esc_attr__( 'verified owner', 'woocommerce' ) . '"><svg xmlns="http://www.w3.org/2000/svg " width="24" height="24" viewBox="0 0 24 24" fill="#067D62">
