jQuery(document).ready(function ($) {
  ...
  if (reviewsSection) {
    ...
    const sliderElement = `<div class="yay-reviews-slider p-4 relative"><div class="flex items-center justify-between py-4"><strong>${yay_reviews.reviews_with_media}</strong><strong class="yay-reviews-see-all-media cursor-pointer underline">${yay_reviews.see_all_media}</strong></div><div class="yay-reviews-all-media-dialog hidden"><div class="yay-reviews-all-media-dialog-content"><div class="yay-reviews-modal-all-media-frame-title flex items-center justify-between"><h1>${yay_reviews.all_media_text}</h1></div><div class="yay-reviews-all-media-dialog-content-wrapper"></div></div></div><div class="yay-reviews-all-media-dialog-backdrop hidden"></div><div class="yay-reviews-slider-wrapper flex items-center justify-center gap-2"><div><button class="yay-reviews-slider-arrow left-arrow" disabled><svg viewBox="0 0 24 24"><polyline points="15 6 9 12 15 18" /></svg></button></div><div class="yay-reviews-slider-track flex overflow-x-auto gap-4"></div><div><button class="yay-reviews-slider-arrow right-arrow"><svg viewBox="0 0 24 24"><polyline points="9 6 15 12 9 18" /></svg></button></div</div></div></div>`;
