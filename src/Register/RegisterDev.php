...
class RegisterDev {
	...
	public function register_all_scripts() {
		...
		wp_register_script( ScriptName::PAGE_SETTINGS, 'http://localhost:3001/main.tsx', $deps, YAY_REVIEWS_VERSION, true ); // phpcs:ignore WordPress.WP.EnqueuedResourceParameters.MissingVersion
