			...
			wp_localize_script(
				...
				array(
					...
					'i18n'            => array(
						...
						'exclude_categories'              => __( 'Exclude Categories', 'yay_reviews' ),
						'exclude_products'                => __( 'Exclude Products', 'yay_reviews' ),
						'select_categories'               => __( 'Select Categories', 'yay_reviews' ),
						'select_products'                 => __( 'Select Products', 'yay_reviews' ),
						'order_products_in'               => __( 'Order products in', 'yay_reviews' ),
						'select_filter'                   => __( 'Select filter', 'yay_reviews' ),
						'user_roles'                      => __( 'User Roles', 'yay_reviews' ),
						'select_user_roles'               => __( 'Select user roles', 'yay_reviews' ),
